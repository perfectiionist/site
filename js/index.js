...
//   div.innerHTML =
//     '<a href="https://yandex.ru/maps" class="yandex__logo" target="_blank"><img src="/site/images/yndex_logo_ru.png" alt="Яндекс Карты" style="height: 40px;"></a>';
//   return div;
// };
...
const customIcon = L.icon({
  iconUrl: "/site/images/hydro-pin.png",
  iconSize: [32, 32],
  iconAnchor: [16, 32],
  popupAnchor: [0, -32],
});
